// Реализовать функцию, которая первым аргументом принимает строку, вторым аргументом массив строк.
// Первый аргумент является зашифрованным именем. Функция должна вернуть строку из подходящих имен.
// Если ни одно имя не подходит вернуть пустую строку
//
...
//
// findMurder ('~~T~~r~pa~e~No', names);//Arthur Paternos
// findMurder (' ~oLA~D~sc~Rs~Ni', names);//Roland Scorsini
// findMurder (' ~~~~~~~~NE', names);//Peter Gone
// findMurder (' w~MOu~T', names);//'W Mount,W Mount'
//
